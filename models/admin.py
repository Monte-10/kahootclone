...
class QuestionAdmin(admin.ModelAdmin):
    list_display = ('question', 'questionnaire', 'created_at', 'updated_at', 'answerTime')
    list_filter = ('questionnaire', 'created_at', 'updated_at', 'answerTime')
    ordering = ('question', 'questionnaire', 'created_at', 'updated_at', 'answerTime')
...
class GameAdmin(admin.ModelAdmin):
    list_display = ('questionnaire', 'created_at', 'state', 'publicId', 'countdownTime', 'questionNo')
    list_filter = ('questionnaire', 'created_at', 'state', 'publicId', 'countdownTime', 'questionNo')
    ordering = ('questionnaire', 'created_at', 'state', 'publicId', 'countdownTime', 'questionNo')
