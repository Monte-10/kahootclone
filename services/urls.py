...
urlpatterns = [
    ...
    path('questionnairelist', views.QuestionnaireList.as_view(),
         name='questionnaire-list'),
    path('questionnaireremove/<int:pk>',
         views.QuestionnaireRemove.as_view(), name='questionnaire-remove'),
    path('questionnaireupdate/<int:pk>',
         views.QuestionnaireUpdate.as_view(), name='questionnaire-update'),
    ...
    path('questionremove/<int:pk>',
         views.QuestionRemove.as_view(), name='question-remove'),
    ...
    path('answerremove/<int:pk>', views.AnswerRemove.as_view(),
         name='answer-remove'),
    path('answerupdate/<int:pk>', views.AnswerUpdate.as_view(),
         name='answer-update'),
    path('gamecreate/<int:questionnaireid>',
         views.GameCreate.as_view(), name='game-create'),
    path('gameUpdateParticipant', views.UpdateParticipant.as_view(),
